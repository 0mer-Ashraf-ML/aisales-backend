...
export class InsertPasswordResetOtpTemplate1744990366996 implements MigrationInterface {
...
<body>
  <div class="container">
    <div class="header">
      <img src="https://sellersgpt.com/logo-light.png" alt="Baq.ai Logo" style="max-width: 100%; height: auto;" />
    </div>
    <div class="content">
    ...
    <div class="footer">
      ...
      <p>&copy; 2025 Baq.ai. All rights reserved.</p>
    </div>
  </div>
</body>
</html>$$,
